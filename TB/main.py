...
async def handle_button_1(message: Message):
    await message.answer("Вы нажали на Тестовую кнопку 1! 🎯")


@dp.message(F.text == "Тестовая кнопка 2")
async def handle_button_2(message: Message):
    await message.answer("Вы нажали на Тестовую кнопку 2! 🔥")


@dp.message(F.text == "Тестовая кнопка 3")
async def handle_button_3(message: Message):
    await message.answer("Вы нажали на Тестовую кнопку 3! ⭐")


# Обработчик текстовых сообщений (исключаем кнопки из обработки)
@dp.message(F.text & ~F.text.in_(["Тестовая кнопка 1", "Тестовая кнопка 2", "Тестовая кнопка 3"]))
